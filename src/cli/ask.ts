...
export const ASK_USAGE = [
  'Usage: omc ask <claude|codex|gemini|kiro> <question or task>',
  '   or: omc ask <claude|codex|gemini|kiro> -p "<prompt>"',
  '   or: omc ask <claude|codex|gemini|kiro> --print "<prompt>"',
  '   or: omc ask <claude|codex|gemini|kiro> --prompt "<prompt>"',
  '   or: omc ask <claude|codex|gemini|kiro> --agent-prompt <role> "<prompt>"',
  '   or: omc ask <claude|codex|gemini|kiro> --agent-prompt=<role> --prompt "<prompt>"',
].join('\n');

const ASK_PROVIDERS = ['claude', 'codex', 'gemini', 'kiro'] as const;
